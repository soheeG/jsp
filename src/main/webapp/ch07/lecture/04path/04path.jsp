...
<body>
	...
	<br />
	<a href="/jsp/ch07/lecture/04path/04path.jsp">절대 경로1 : /jsp/ch07/lecture/04path/04path.jsp</a>
	<br />
	
	<!-- http://localhost:8080/jsp/ch07/lecture/05path.jsp -->
	<a href="../05path.jsp">상대 경로2 : ../05path.jsp</a>
	<br />
	<a href="/jsp/ch07/lecture/05path.jsp">절대 경로2 : /jsp/ch07/lecture/05path.jsp</a>
	<br />
	
	<!-- http://localhost:8080/jsp/ch07/05path.jsp -->
	<a href="../../05path.jsp">상대 경로3 : ../../05path.jsp</a>
	<br />
	<a href="/jsp/ch07/05path.jsp">절대 경로3 :/jsp/ch07/05path.jsp</a>
